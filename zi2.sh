...
# Diubah dari zahidbd2/udp-zivpn
wget https://github.com/Ris-Project/zipvpn/releases/download/udp-zivpn_1.4.9/udp-zivpn-linux-arm64 -O /usr/local/bin/zivpn 1> /dev/null 2> /dev/null
